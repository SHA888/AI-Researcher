    ...
    async def compose_section(
        ...
        if subsection_checkpoint:
            ...
            for subsection_id, subsection in enumerate(
                ...
                self.write_temp_log(methodology_part, f"subsection_{subsection_id}_code")
                ...
                for i, agent_file in enumerate(agent_files):
                    ...
                    self.write_temp_log(methodology_part, f"subsection_{subsection_id}_agent_{i}")
...
async def methodology_composing(research_field: str, instance_id: str):
    ...
    # sss
    try:
        await composer.compose_section(agent_dir, model_dir, benchmark_path, instance_id)
