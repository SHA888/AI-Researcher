...
import numpy as np
import tenacity
from browsergym.core.action.functions import demo_mode, get_elem_by_bid, goto, page
...
def _visit_page(url: str):
    ...
    try:
        ...
        # 处理文件下载情况
        if "net::ERR_ABORTED" in str(e_outer) or "net::ERR_CONNECTION_REFUSED" in str(
            e_outer
        ):
            import base64
            import os
