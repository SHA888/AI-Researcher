...
def main():
    ...
    for epoch in range(config.epochs):
        ...
        print(
            f"Epoch {epoch+1}: Loss={avg_loss:.4f}, BPR Loss={avg_loss_bpr:.4f}, Contrast Loss={avg_loss_contrast:.4f}"
        )
        ...
        with torch.no_grad():
            ...
            print(
                f"Test Results: Recall@20={avg_recall_20:.4f}, NDCG@20={avg_ndcg_20:.4f}, "
    ...
    results_df.to_csv(
        f"/workplace/project/results_gowalla_{timestamp}.csv", index=False
    )
