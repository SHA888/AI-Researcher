...
class HeteroContrastiveModel(nn.Module):
    ...
    def forward(self, user_graph, user_item_graph, item_graph):
        ...
        user_emb_main, item_emb_main = self.main_gnn(
    ...
    def calculate_loss(
        self, user_graph, user_item_graph, item_graph, users, pos_items, neg_items
    ):
        ...
        bpr_loss = self.calc_bpr_loss(
            user_emb_main, item_emb_main, users, pos_items, neg_items
        )
